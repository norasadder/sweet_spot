...
<div class="containerOrders" >
    <?php
    $query="SELECT * FROM orders where TrackingFlag	=1";
...
<div class="orderDetailsContainer" id="orderDetailsContainer" >
    ...
    <form method="post" id="buttomform">
        <p class="send"> To delivery : </p>
        <p class="orderDetailsButton3"> send to delivery </p>
...
if(isset($_POST['SendToDelivery'])){
    ...
    $sql1 = "UPDATE `orders` SET `TrackingFlag`=2 WHERE OID=".$x ;
